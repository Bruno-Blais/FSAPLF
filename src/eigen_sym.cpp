...
*   File    : eigen_sym.cpp
*
*   Description :   Routines to solve eigenvalues problems for symmetric matrices
*
*
********************************************************************************************/
...
Jacobi::Jacobi(MatDoub_I &aa) : n(aa.nrows()), a(aa), v(n,n), d(n), nrot(0),
...
inline void Jacobi::rot(MatDoub_IO &a, const Doub s, const Doub tau, const Int i,
...
Symmeig::Symmeig(MatDoub_I &a, Bool yesvec=true) : n(a.nrows()), z(a), d(n),
    e(n), yesvecs(yesvec)
{
    tred2();
    tqli();
...
Symmeig::Symmeig(VecDoub_I &dd, VecDoub_I &ee, Bool yesvec=true) :
